...
class Personagem:
    ...
    def atacar(self, alvo):
        ...
        print(f"{self.__nome} atacou {alvo.get_nome()} causando {dano} de dano!")
...
class Heroi(Personagem):
    ...
    def ataque_especial(self, alvo):
        ...
        alvo.receber_ataque(dano)
        print(f"{self.get_nome()} atacou {alvo.get_nome()} com habilidade especial causando {dano} de dano!")
