...
class MinhaClasse:
  ...
  # requer uma instância para ser chamado / tem acesso a atributos da instância e classe
  def metodo_instancia(self):
    return f"Método de instância chamado para {self.nome}"
  
  # não requer uma instância / não tem acesso a atributos da instância
  @classmethod
  def metodo_classe(cls):
    return f"Método de classe chamado para valor={cls.valor}"
  
  # não tem acesso a atributos da instância ou classe
  @staticmethod
  def metodo_estatico():
